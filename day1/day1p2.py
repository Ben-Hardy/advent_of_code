...
# once this is created it's simply a case of repeating part 1 to create a list of binary values representing whether a window sum is smaller than its successor or not
